...
<div class="be-content">
    <div class="page-head">
        <h2 class="page-head-title">List of FIRS </h2>
        <nav aria-label="breadcrumb" role="navigation">
            <ol class="breadcrumb page-head-nav">
                <li class="breadcrumb-item"><a href="#">Home</a></li>
                <li class="breadcrumb-item active">List of FIRS </li>
            </ol>
        </nav>
    </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card card-table">
                    <div class="card-header"> <i class="mdi mdi-format-list-bulleted"></i> List of FIRS
                            ...
                            <tbody>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        <div class="row">
                                            <!-- <div class="col-xs-3">
                                                <a href="{{ route('causelist.edit', $f->per_fir) }}" class="btn btn-rounded btn-space btn-info btn-xs">
                                                    edit
                                                </a>
                                            </div> -->
                                            <div class="col-xs-3">
                                                <a href="{{ route('delete_fir',$f->per_fir) }}">
                                                    <button class="btn btn-rounded btn-space btn-danger btn-xs">
                                                        delete
                                                    </button>
                                                </a>
                                            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header modal-header-colored">
                <h3 class="modal-title"><i class="mdi mdi-collection-plus"></i> Add Cause List</h3>
                <button class="close md-close" type="button" data-dismiss="modal" aria-hidden="true"><span class="mdi mdi-close"> </span></button>
            </div>
            <div class="modal-body">
                <form action="{{ route('add_fir') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <label>Select Police Station</label>
                        <select class="form-control" name="police_station">
                            @foreach($police_station as $f)
                            <option value="{{ $f->id }}">{{ $f->police_station_name }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label>Fir No</label>
                        <input type="text" name="fir_no" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label>Date</label>

...
<div class="be-content">
    <div class="page-head">
        <h2 class="page-head-title">List of Police Stations</h2>
        <nav aria-label="breadcrumb" role="navigation">
            <ol class="breadcrumb page-head-nav">
                <li class="breadcrumb-item"><a href="#">Home</a></li>
                <li class="breadcrumb-item active">List of Police Stations </li>
            </ol>
        </nav>
    </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card card-table">
                    <div class="card-header"> <i class="mdi mdi-format-list-bulleted"></i> List of Police Stations
                    ...
                    <div class="card-body">
                        <table class="table table-striped table-hover table-fw-widget" id="table1">
                            ...
                            <tbody>
                                @foreach($police_station as $link)
                                <tr class="odd gradeX">
                                    <td>
                                        {{ $link->id }}
                                    </td>
                                    <td>
                                        {{ $link->police_station_name }}
                                    </td>
                                    <td>
                                        <div class="row">
                                            <div class="col-xs-3">
                                                <a href="{{ route('delete_police_station',$link->id) }}">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header modal-header-colored">
                <h3 class="modal-title"><i class="mdi mdi-collection-plus"></i> Add Police Station</h3>
                <button class="close md-close" type="button" data-dismiss="modal" aria-hidden="true"><span class="mdi mdi-close"> </span></button>
            </div>
            <div class="modal-body">
                <form action="{{ route('add_police_station') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <label>Add Police Station</label>

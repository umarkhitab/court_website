...
<div class="be-content">
    <div class="page-head">
        <h2 class="page-head-title">List of Judicial Officers Title</h2>
        <nav aria-label="breadcrumb" role="navigation">
            <ol class="breadcrumb page-head-nav">
                <li class="breadcrumb-item"><a href="#">Home</a></li>
                <li class="breadcrumb-item active">List of Judicial Officers Title </li>
            </ol>
        </nav>
    </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card card-table">
                    <div class="card-header"> <i class="mdi mdi-format-list-bulleted"></i> List of Judicial Officers Title
                        <div class="tools dropdown">
                            <button class="btn btn-rounded btn-space btn-primary" data-toggle="modal" data-target="#form-bp2">
                                Add Link
                            </button>
                        </div>
                    </div>
                    <div class="card-body">
                        <table class="table table-striped table-hover table-fw-widget" id="table1">
                            ...
                            <tbody>
                                @foreach($JudicialOfficersLinks as $link)
                                <tr class="odd gradeX">
                                    <td>
                                        {{ $link->id }}
                                    </td>
                                    ...
                                    <td>
                                        <div class="row">
                                            <div class="col-xs-3">
                                                <form action="{{ route('judofficerslinks.destroy',$link->id) }}" method="POST">
                                                    {{ method_field('DELETE') }}
                                                    {!! csrf_field() !!}
...
<!-- Head Expenses Modal -->
<div class="modal fade colored-header colored-header-primary" id="form-bp2" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header modal-header-colored">
                <h3 class="modal-title"><i class="mdi mdi-collection-plus"></i> Add Judicial Officers Title</h3>
                <button class="close md-close" type="button" data-dismiss="modal" aria-hidden="true"><span class="mdi mdi-close"> </span></button>
            </div>
            <div class="modal-body">
                <form action="{{ route('judofficerslinks.store') }}" method="post" enctype="multipart/form-data">
                    @csrf

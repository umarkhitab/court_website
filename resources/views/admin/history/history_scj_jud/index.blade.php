...
<div class="be-content">
    <div class="page-head">
        <h2 class="page-head-title">History of Senior Civil Judges (Judicial) </h2>
        <nav aria-label="breadcrumb" role="navigation">
            <ol class="breadcrumb page-head-nav">
                <li class="breadcrumb-item"><a href="#">Home</a></li>
                <li class="breadcrumb-item active">History of Senior Civil Judges (Judicial) </li>
            </ol>
        </nav>
    </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card card-table">
                    <div class="card-header"> <i class="mdi mdi-format-list-bulleted"></i> History of Senior Civil Judges (Judicial)
                            ...
                            <tbody>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        <div class="row">
                                            <div class="col-xs-3">
                                                <a href="{{ route('scj_edit_jud',$history->id) }}" class="btn btn-rounded btn-space btn-info btn-xs">
                                                    edit
                                                </a>
                                            </div>
                                            <div class="col-xs-3">
                                                <a href="{{ route('scj_delete_jud',$history->id) }}" class="btn btn-rounded btn-space btn-danger btn-xs"> delete </a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header modal-header-colored">
                <h3 class="modal-title"><i class="mdi mdi-collection-plus"></i> History of Senior Civil Judges (Judicial)</h3>
                <button class="close md-close" type="button" data-dismiss="modal" aria-hidden="true"><span class="mdi mdi-close"> </span></button>
            </div>
            <div class="modal-body">
                <form action="{{ route('scj_store_jud') }}" method="post" enctype="multipart/form-data">
                    @csrf

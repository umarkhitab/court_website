...
<div class="be-content">
    <div class="page-head">
        <h2 class="page-head-title">List of Pircture Gallery </h2>
        <nav aria-label="breadcrumb" role="navigation">
            <ol class="breadcrumb page-head-nav">
                <li class="breadcrumb-item"><a href="#">Home</a></li>
                <li class="breadcrumb-item active">List of Pircture Gallery </li>
            </ol>
        </nav>
    </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card card-table">
                    <div class="card-header"> <i class="mdi mdi-format-list-bulleted"></i> List of Pircture Gallery
                        <div class="tools dropdown">
                            <button class="btn btn-rounded btn-space btn-primary" data-toggle="modal"
                                data-target="#form-bp1">
                                Add Pircture Gallery
                            </button>
                        </div>
                    </div>
                    <div class="card-body">
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        <div class="row">
                                            ...
                                            <div class="col-xs-3">
                                                <form action="{{ route('pic.destroy',$pic->id) }}" method="POST">
                                                    {{ method_field('DELETE') }}
                                                    {!! csrf_field() !!}
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header modal-header-colored">
                <h3 class="modal-title"><i class="mdi mdi-collection-plus"></i> Add Picture Gallery</h3>
            ...
            <div class="modal-body">
                <form action="{{ route('pic.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <p>Press Ctrl to select multiple Files</p>
                    </div>
                    {{-- <div class="form-group">

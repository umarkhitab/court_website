                        ...
                        <table class="table table-striped table-hover table-fw-widget" id="table1">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><a href="{{ route('applications_for_appointment') }}" class="btn btn-success">Upload Files</a></td>
                                </tr>
                                <tr>
                                    <td>2</td>
                                    <td>Applications for Appointment of Receiver</td>
                                    <td><a href="{{ route('appointment_of_receiver') }}" class="btn btn-success">Upload Files</a></td>
                                </tr>
                                <tr>
                                    <td>3</td>
                                    <td>Applications for Restitution under section 144 CPC</td>
                                    <td><a href="{{ route('applications_for_restitution') }}" class="btn btn-success">Upload Files</a></td>
                                </tr>
                                <tr>
                                    <td>4</td>
                                    <td>Temporary Injunction Applications</td>
                                    <td><a href="{{ route('temporary_injunction_applications') }}" class="btn btn-success">Upload Files</a></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>

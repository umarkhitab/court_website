                        ...
                        <table class="table table-striped table-hover table-fw-widget" id="table1">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><a href="{{ route('appeal-against-decree') }}" class="btn btn-success">View</a></td>
                                </tr>
                                <tr>
                                    <td>2</td>
                                    <td>Criminal Appeal and documents or forms of dcouments to be annexed</td>
                                    <td><a href="{{ route('criminal_appeal') }}" class="btn btn-success">View</a></td>
                                </tr>
                                <tr>
                                    <td>3</td>
                                    <td>Family Court Appeal and documents or forms of dcouments to be annexed</td>
                                    <td><a href="{{ route('family_court') }}" class="btn btn-success">View</a></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>

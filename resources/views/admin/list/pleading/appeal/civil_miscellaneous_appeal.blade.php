...
<div class="be-content">
    <div class="main-content container-fluid">
        ...
        <div class="alert alert-contrast alert-success alert-dismissible" role="alert">
            ...
            <div class="message">
                <button class="close" type="button" data-dismiss="alert" aria-label="Close"><span class="mdi mdi-close" aria-hidden="true">
                </span></button><strong> {{ $message }} </strong>
            </div>
        </div>
        @endif
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('upload_civil_miscellaneous_appeal') }}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}

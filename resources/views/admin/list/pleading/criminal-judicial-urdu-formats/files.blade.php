                    ...
                    <div class="card-body">
                        <table class="table table-striped table-hover table-fw-widget" id="table1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $f->id }}</td>
                                    <td><a href="{{ asset($f->file) }}">{{ basename($f->file) }}</a></td>
                                    <td>
                                        <a href="{{ route('delete_up_criminal_judicial',$f->id) }}" class="btn btn-danger">
                                            Delete
                                        </a>
                                    </td>
                                </tr>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('up-criminal-judicial-urdu-formats') }}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}

                        ...
                        <table class="table table-striped table-hover table-fw-widget" id="table1">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><a href="{{ route('civil_revision_petition') }}" class="btn btn-success">Upload Files</a></td>
                                </tr>
                                <tr>
                                    <td>2</td>
                                    <td>Criminal Revision Petition</td>
                                    <td><a href="{{ route('criminal_revision_petition') }}" class="btn btn-success">Upload Files</a></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>

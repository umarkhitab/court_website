                        ...
                        <table class="table table-striped table-hover table-fw-widget" id="table1">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><a href="{{ route('application_under_section_22') }}" class="btn btn-success">Upload Files</a></td>
                                </tr>
                                <tr>
                                    <td>2</td>
                                    <td>Petition under section 133 CrPC</td>
                                    <td><a href="{{ route('petition_under_section_133') }}" class="btn btn-success">Upload Files</a></td>
                                </tr>
                                <tr>
                                    <td>3</td>
                                    <td>Petition under section 145 CrPC</td>
                                    <td><a href="{{ route('petition_under_section_145') }}" class="btn btn-success">Upload Files</a></td>
                                </tr>
                                <tr>
                                    <td>4</td>
                                    <td>Post Arrest Bail Application</td>
                                    <td><a href="{{ route('pre_arrest_bail_application') }}" class="btn btn-success">Upload Files</a></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>

...
<div class="be-content">
    <div class="page-head">
        <h2 class="page-head-title"> Gallery Images Titles</h2>
        <nav aria-label="breadcrumb" role="navigation">
            <ol class="breadcrumb page-head-nav">
                <li class="breadcrumb-item"><a href="#">Home</a></li>
                <li class="breadcrumb-item active"> Gallery Images Titles </li>
            </ol>
        </nav>
    </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card card-table">
                    <div class="card-header"> <i class="mdi mdi-format-list-bulleted"></i> Gallery Images Titles
                        <div class="tools dropdown">
                            <button class="btn btn-rounded btn-space btn-primary" data-toggle="modal"
                                data-target="#form-bp1">Add New Title</button>
                        </div>
                    </div>
                    <div class="card-body">
                            ...
                            <tbody>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        <div class="row">
                                            <div class="col-xs-3">
                                                <form action="{{ route('pic_titles.destroy',$gal->id) }}" method="POST">
                                                    {{ method_field('DELETE') }}
                                                    {!! csrf_field() !!}
                                            ...
                                            <div class="col-xs-3">
                                            <a href="{{ route('pic_titles.edit',$gal->id) }}" class="btn btn-rounded btn-space btn-info btn-xs text-white"> Edit
                                                </a>
                                            </div>
                                        </div>
                                    </td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('pic_titles.store') }}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}

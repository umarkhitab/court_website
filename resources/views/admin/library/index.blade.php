                        ...
                        <table class="table table-striped table-hover table-fw-widget" id="table1">
                            ...
                            <tbody>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        <a href="{{ $library->file }}">{{  basename($library->file) }}</a>
                                    ...
                                    <td>
                                        <div class="row">
                                            ...
                                            <div class="col-xs-3">
                                                <form action="{{ route('library.destroy',$library->id) }}"
                                                    method="POST">
                                                    {{ method_field('DELETE') }}
                                                    {!! csrf_field() !!}
            ...
            <div class="modal-body">
                <form action="{{ route('library.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="serial" class="form-control" rows="4" required>
                    </div>
                    <div class="form-group">
                        <label>Folder Name</label>
                        <input name="folder_name" type="text" class="form-control" rows="4" required>
                    </div>
                    {{-- <div class="form-group">
                        <label>Pages</label>
                        <input type="text" name="pages" class="form-control" rows="4" required>
                    </div>
                    <div class="form-group">
                        <label>Publish Date</label>
                        <input type="date" name="publish_date" class="form-control" rows="4" required>
                    </div>
                    <div class="form-group">
                        <label>Publisher</label>
                        <input type="text" name="publisher" class="form-control" rows="4" required>
                    </div> --}}
                    <div class="form-group">
